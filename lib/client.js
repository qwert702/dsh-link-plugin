...
`
      ...
      return React.createElement('li', { className: 'dsh-link-set-card' },
        React.createElement('button', {
          ...
          React.createElement('span', { className: 'dsh-link-set-headtext' },
            React.createElement('span', { className: 'dsh-link-set-title' }, '远程连接 dsh.cbnac'),
            React.createElement('span', { className: 'dsh-link-set-desc' }, '连接 dsh.cbnac.com,从浏览器远程安装插件'),
          ),
    ...
    function apply(ctx) {
      ...
      slots.inject('settings.plugin.item', () => slots.register(
        { name: 'settings.plugin.item', id: 'dsh-link', order: 10 },
